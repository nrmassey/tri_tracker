...
void indexed_force_tri_3D::add_index(int ii, int ij, vector_3D cart_coord, FP_TYPE W)
{
    ...
    if (std::find(grid_indices.begin(), grid_indices.end(), gdx) == grid_indices.end())
